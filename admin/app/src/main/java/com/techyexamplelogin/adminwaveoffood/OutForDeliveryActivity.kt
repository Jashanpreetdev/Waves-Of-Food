...
import com.techyexamplelogin.adminwaveoffood.adapter.DeliveryAdapter
import com.techyexamplelogin.adminwaveoffood.databinding.ActivityOutForDeliveryBinding
    ...
    private fun retrieveCompleteOrderDetails() {
        ...
        completeOrderReference.addListenerForSingleValueEvent(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                //reverse the list to display the reverse order first
